<?php
    ...
    // }
    $_SESSION["queryFooter"]="SELECT * from items where it_ca_id='CA019'";
        ...
        <nav class="navbar navbar-expand-lg sticky-top w-100" style="background-color:#3F4441;">
            <div class="container-fluid">
                <a class="navbar-brand" href="../index.php" name="logodipencet">
                    ...
                    <div class="text-white">RUANG MAKAN</div>
                </a>
                ...
                <ul class="pagination" class="w-100 d-flex">
                        ...
                        if($now==1){
                            ...
                            ?>
                                <li class="page-item d-flex">
                                    <a class="page-link" href="ruangMakan.php?page=<?=$now-1?>">Previous</a>
                                </li>
                            <?php
                        }
                    ?>
                            ...
                            if($page==$now){
                                ?>
                                    <li class="page-item active d-flex" aria-current="page">
                                        <a class="page-link" href="ruangMakan.php?page=<?=$page?>"><?=$page?></a>
                                    </li>
                                <?php
                            }
                            else{
                    ...
                    <?php
                        if($now==$number_of_page){
                            ...
                            ?>
                                <li class="page-item d-flex">
                                    <a class="page-link" href="ruangMakan.php?page=<?=$now+1?>">Next</a>
                                </li>
                            <?php
                        }
                    ?>
