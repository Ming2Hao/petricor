    ...
    <div class="container-fluid">
        ...
        <div class="d-flex container-fluid">
            ...
            <div class="input-group">
                <input type="text" class="form-control ms-lg-2" placeholder="Cari barang" style="height:34px; margin-top:2px;">
                <button class="rounded-end me-5" style="border:none; background-color:white; margin-top:2px;">
        ...
        ?>
                ...
                <div class="col">
                    <div class="card" style="width: 300px; height: 280px; box-shadow: #3F4441 12px 15px 15px -20px; border-radius:15px">
                        <button class="btn p-1 btnHover" style="border-radius:15px; width: 300px; height:280px;">
                            <div class="bg-image hover-zoom">
                                <img src="<?=$daftarBarang[$i]['it_gambar']?>" class="card-img-top bg-image hover-zoom" alt="..." style="width:200px; top:0; margin-left:auto; margin-right:auto;">
                            </div>
                            
                            <div class="card-body p-0">
                                <p class="text-secondary mb-0">Kategori Barang</p>
                                <p class="card-title mb-0" style="font-size:14px;"><?=$daftarBarang[$i]['it_name']?></p>
                                ...
                                <p class="text-danger"><?=$daftarBarang[$i]['it_price'] ?> <span class="text-secondary" style="text-decoration:line-through">IDR <?=number_format(17187989, 0, "", ".")?></span></p>
                            </div>
                        </button>
                    </div>
                </div>
